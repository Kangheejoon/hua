...
//% weight=10 color=#008B00 icon="\uf136" block="Maqueen-C"
//% groups=['micro:bit(C)']
namespace maqueen {
    let kbCallback: KV[] = []
    ...
    //% weight=2
    //% blockGap=50
    //% blockId=IR_callbackUser block="IR 수신으로"
    ...
    //% weight=2
    //% group="micro:bit(v2)"
    //% blockId=IR_callbackUserv2 block="IR 수신으로"
    //% draggableParameters
...
function valuotokeyConversion():number{
    ...
    //% weight=10
    //% blockId=IR_read_version block="제품 정보 얻기"
    ...
    //% blockId=ultrasonic_sensor block="초음파 센서읽기  |%unit "
    //% weight=95
    ...
    //% weight=90
    //% blockId=motor_MotorRun block="모터|%index|움직임|%Dir||%speed"
    ...
    //% weight=20
    //% blockId=motor_motorStop block="모터 |%motors stop"
    ...
    //% weight=20
    //% blockId=read_Patrol block="읽기 |%patrol 라인감지센서"
     ...
     */
    //% weight=2
    //% blockId=kb_event block="on|%value 라인 추적센서|%vi"
